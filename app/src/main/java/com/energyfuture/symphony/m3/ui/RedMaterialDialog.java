 ...
 */
public class RedMaterialDialog {
    ...
    public RedMaterialDialog(Context context) {
    ...
    public RedMaterialDialog setView(View view) {
        mView = view;
        if (mBuilder != null) {
    ...
    public RedMaterialDialog setContentView(View view) {
    ...
    public RedMaterialDialog setBackground(Drawable drawable) {
    ...
    public RedMaterialDialog setBackgroundResource(int resId) {
    ...
    public RedMaterialDialog setTitle(int resId) {
        mTitleResId = resId;
        if (mBuilder != null) {
    ...
    public RedMaterialDialog setTitle(CharSequence title) {
        mTitle = title;
        if (mBuilder != null) {
    ...
    public RedMaterialDialog setMessage(int resId) {
        mMessageResId = resId;
        if (mBuilder != null) {
    ...
    public RedMaterialDialog setMessage(CharSequence message) {
        mMessage = message;
        if (mBuilder != null) {
    ...
    public RedMaterialDialog setPositiveButton(int resId, final View.OnClickListener listener) {
    ...
    public RedMaterialDialog setPositiveButton(String text, final View.OnClickListener listener) {
        mPositiveButton = new Button(mContext);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT
    ...
    public RedMaterialDialog setChangeButton(int resId, final View.OnClickListener listener) {
        mChangeButton = new Button(mContext);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT
        );
        mChangeButton.setLayoutParams(params);
        mChangeButton.setBackgroundResource(R.drawable.button);
        mChangeButton.setTextColor(Color.argb(255, 35, 159, 242));
        mChangeButton.setText(resId);
        mChangeButton.setGravity(Gravity.CENTER);
        mChangeButton.setTextSize(14);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT
        );
        layoutParams.setMargins(dip2px(2), 0, dip2px(12), dip2px(BUTTON_BOTTOM));
        mChangeButton.setLayoutParams(layoutParams);
    ...
    public RedMaterialDialog setChangeButton(String text, final View.OnClickListener listener) {
        mChangeButton = new Button(mContext);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT
        ...
        mChangeButton.setOnClickListener(listener);
        if (isLollipop()) {
            mChangeButton.setBackgroundResource(android.R.color.transparent);
        }
        return this;
    }

    public RedMaterialDialog setNegativeButton(int resId, final View.OnClickListener listener) {
    ...
    public RedMaterialDialog setNegativeButton(String text, final View.OnClickListener listener) {
        mNegativeButton = new Button(mContext);
        mLayoutParams = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT
    ...
    public RedMaterialDialog setCanceledOnTouchOutside(boolean cancel) {
        this.mCancel = cancel;
        if (mBuilder != null) {
    ...
    public RedMaterialDialog setOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
    ...
    private class Builder {
        ...
        private Builder() {
            ...
            mAlertDialogWindow.setBackgroundDrawableResource(R.drawable.abc_btn_check_to_on_mtrl_000);
...
//7
            ...
            if (mChangeButton != null) {
                mButtonLayout.addView(mChangeButton);
            }
         ...
         * @param listener
         */
        public void seChangeButton(String text, final View.OnClickListener listener) {
            Button button = new Button(mContext);
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
            button.setLayoutParams(params);
            button.setBackgroundResource(R.drawable.material_card);

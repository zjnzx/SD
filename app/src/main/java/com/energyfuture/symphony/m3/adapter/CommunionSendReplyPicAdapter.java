 ...
 */
public class CommunionSendReplyPicAdapter extends BaseAdapter {
    ...
    public CommunionSendReplyPicAdapter(Context context,List<String> list,String id,String picUrl,String opicUrl,String themeId){

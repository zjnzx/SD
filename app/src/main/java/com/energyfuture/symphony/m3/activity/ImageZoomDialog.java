...
import com.energyfuture.symphony.m3.util.FileUtils;
import com.energyfuture.symphony.m3.util.ImageUtils;
 ...
 * @created 2012-3-21
 */
public class ImageZoomDialog extends ActionBarActivity// implements OnTouchListener, OnClickListener
{
    ...
    private void setToolbar(){
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_image_dialog);
        toolbar.setTitle("");
...
//					CheckView();// 设置图像居中
		...
		new Thread(){
			public void run() {
				...
				try {
					//读取本地图片
					if(imgURL.endsWith(".jpg") || StringUtils.isEmpty(imgURL)){
					...
					if(bmp == null){
						bmp = ApiClient.getNetBitmap(imgURL,ImageZoomDialog.this,"文件");
						if(bmp != null){
							try {
		                    	//写图片缓存
								...
								e.printStackTrace();
                                Constants.recordExceptionInfo(e,ImageZoomDialog.this,"ImageZoomDialog");
							}
							//缩放图片

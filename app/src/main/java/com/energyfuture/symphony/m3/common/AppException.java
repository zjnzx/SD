...
public class AppException extends Exception implements UncaughtExceptionHandler{
    ...
    public void printStackTrace() {
        String title = "无类型";
        if(this.getType() == 0x01 || this.getType() == 0x02 || this.getType() == 0x03 || this.getType() == 0x04){
            title = "网络异常";
        }else if(this.getType() == 0x05){
            title = "XML异常";
        }else if(this.getType() == 0x06){
            title = "IO异常";
        }else if(this.getType() == 0x07){
            title = "运行时异常";
        }else if(this.getType() == 0x08){
            title = "JSON异常";
        }
//        Log.e(title, getMessage());
    }

    public void printStackTrace(String msgTitle) {
        Log.e(msgTitle, getMessage());
    }
}

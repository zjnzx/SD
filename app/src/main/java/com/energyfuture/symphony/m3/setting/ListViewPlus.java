package com.energyfuture.symphony.m3.setting;
...
/**
 * 鍩轰簬ListView鐨勮嚜瀹氫箟鎺т欢瀹炵幇涓婃媺鍔犺浇涓嬫媺鍒锋柊
 *
 * @author JPH
 * @date 2015-3-10 涓嬪崍1:01:56
 */
public class ListViewPlus extends ListView implements OnScrollListener {
    ...
    public void onScroll(AbsListView view, int firstVisibleItem,
        ...
        if (mFooterView != null) {
            if (totalItemCount < minItemCount + 2) {// 濡傛灉ListView涓彧鍖呭惈澶村竷灞�拰灏惧竷灞�紙鍙奓istView鐨刟dapter娌℃湁鏁版嵁锛夛紝鍒欎笉鏄剧ず鑴氬竷灞�枃浠�				this.removeFooterView(mFooterLayout);
            } else {
    ...
    /**
     * 瀹炵幇杩欎釜鎺ュ彛鍙互锛岃幏鍙栦笅鎷夊姞杞戒笂鎷夊埛鏂颁簨浠�
     */
    ...
    class ListViewPlusFooter extends LinearLayout {
        ...
        public void setState(int state) {
            ...
            SharedPreferences sharedPreferences = mContext.getSharedPreferences("ISOK", Activity.MODE_PRIVATE);
            String isok = sharedPreferences.getString("isok", "");
            if (state == mState)
                return;

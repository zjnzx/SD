...
public class DownloadManager {
    ...
    /*package*/ DownloadManager(Context appContext) {
        ...
        try {
            ...
            Constants.recordExceptionInfo(e, appContext, appContext.toString()+"/DownloadManager");
        }
    ...
    public class ManagerCallBack extends RequestCallBack<File> {
        ...
        public void onStart() {
            ...
            try {
                ...
                LogUtils.e(e.getMessage(), e);
                Constants.recordExceptionInfo(e, mContext, mContext.toString()+"/DownloadManager");
            }

...
public class MaterialDialog {
    ...
    public MaterialDialog setChangeButton(int resId, final View.OnClickListener listener) {
    ...
    public MaterialDialog setChangeButton(String text, final View.OnClickListener listener) {
        mChangeButton = new Button(mContext);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT

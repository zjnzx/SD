 ...
 * 图片查看器
 */
public class ImagePagerCommActivity extends FragmentActivity {
	private static final String STATE_POSITION = "STATE_POSITION";
	public static final String EXTRA_IMAGE_INDEX = "image_index"; 
	private HackyViewPager mPager;
	private int pagerPosition;
    private String picUrl,id,type,localurl;
    ...
    private void queryAccessory(){
        SympCommunicationAccessoryDao sympCommunicationAccessoryDao = new SympCommunicationAccessoryDao(this);
        ...
        if(type.equals("1")){
            ...
            sympCommunicationAccessory.setReplyid(id);
        }
        //查询图片的信息

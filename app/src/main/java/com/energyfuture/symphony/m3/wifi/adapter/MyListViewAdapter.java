package com.energyfuture.symphony.m3.wifi.adapter;
...
//				tag.txtWifiDesc.setTextColor(context.getResources().getColor(R.color.textdec));
                holder.txtWifiName.setTextColor(Color.parseColor("#00C55B"));
                holder.txtWifiDesc.setTextColor(Color.parseColor("#00C55B"));

                ((WifiListActivity)context).inioImport();
            }else{
                holder.txtWifiName.setTextColor(Color.parseColor("#000000"));
                holder.txtWifiDesc.setTextColor(Color.parseColor("#000000"));
            }
        }
        if(wifi==State.DISCONNECTED){
            ...
            ((WifiListActivity)context).restoreImpotr();
        }
